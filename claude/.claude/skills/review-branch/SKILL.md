...
| 4 | security-reviewer | sonnet | `$HOME/dotfiles/claude/.claude/agents/security-reviewer.md` を参照し、セキュリティ問題を検出 |
...
- OWASP Top 10 を分析
- 認証・入力検証・機密情報を重点チェック
- グローバルエージェント `$HOME/dotfiles/claude/.claude/agents/security-reviewer.md` を参照
